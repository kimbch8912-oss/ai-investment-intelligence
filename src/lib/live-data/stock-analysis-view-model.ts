...
export function liveDataMetadata(snapshot: LiveDataSnapshot) {
  return { sourceMode: 'LIVE' as const, sourceCoverage: snapshot.coverage.ratio, sourceStatuses: { ...snapshot.sourceStatus } };
}
