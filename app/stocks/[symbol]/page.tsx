...
export default async function StockPage({ params }: Props) {
  ...
  if (live.kind === 'ready') return <div id="app"><aside className="side"><b>Stock Intelligence</b><small>Analysis Dashboard</small><p>ANALYSIS</p><span>종목 분석</span><p>DATA STATUS</p><small>LIVE · {live.snapshot.marketData.freshness.freshnessStatus}</small></aside><div className="page-content"><StockDashboardV2 fixture={live.viewModel} /></div></div>;
